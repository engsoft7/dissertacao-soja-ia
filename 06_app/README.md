...
- Exibe um **mapa clicável do Pará** com todos os municípios produtores
  (clicar num ponto seleciona o município); a vista fica **travada no estado**,
  com um botão para destravar e permitir arrastar/zoom. Usa a **grafia oficial
  acentuada** dos nomes (IBGE) — a base bruta vem do GAUL, sem acentos.

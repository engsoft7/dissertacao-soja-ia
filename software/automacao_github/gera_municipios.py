# -*- coding: utf-8 -*-
"""Gera pesquisa/dados/municipios_para.csv: nome oficial acentuado + centroide (lat/lon).
...
BASE = RAIZ / "pesquisa" / "dados" / "soja_para_mascarado_2001_2024.csv"
SAIDA = RAIZ / "pesquisa" / "dados" / "municipios_para.csv"

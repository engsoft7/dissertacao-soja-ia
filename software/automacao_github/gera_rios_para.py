# -*- coding: utf-8 -*-
"""Gera pesquisa/dados/rios_para.json: principais rios do Pará (Natural Earth, recortado).

Baixa a malha de rios do Natural Earth (10m, centerlines), recorta pelo polígono
do Pará (pesquisa/dados/para_geo.json) e mantém só os trechos maiores — dá contexto
...
GEO_PARA = RAIZ / "pesquisa" / "dados" / "para_geo.json"
SAIDA = RAIZ / "pesquisa" / "dados" / "rios_para.json"
